...
function postfind(form,url){
	postform(document.form1,'gmcharlog_backup.php')
}
//-->
</script>
</head>
<body>
<form name="form2" method="post" action="gmcharlog_backup.php">
...
<p>
<?=$hd?>
<form name="form1" method="post" action="gmcharlog_backup.php">
