...
//require_once('dbGmAdm.php');
		$query_rsGmSvr = "INSERT INTO gm_server(id, name, type, ip, db, dbuser, dbpasswd, authsys) VALUES(0, '{$HTTP_POST_VARS[name_0]}', '{$HTTP_POST_VARS[type_0]}', '{$HTTP_POST_VARS[ip_0]}', '{$HTTP_POST_VARS[db_0]}', '{$HTTP_POST_VARS[dbuser_0]}', '{$HTTP_POST_VARS[dbpasswd_0]}', '{$HTTP_POST_VARS[authsys_0]}')";
		mysql_select_db($database_dbGmAdm, $dbGmAdm);
