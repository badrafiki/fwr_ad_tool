...
-->
	...
	<tr valign=top>
		<td colspan=2><textarea name="para2" id="para2" rows=15 cols=100 onmousemove="chklen(2)" onkeyup="chklen(2)" onmouseout="chklen(2)"><?=$motd_simpc?></textarea></td>
	</tr>
</table>
<script>chklen(1);chklen(2);chklen(0)</script>
